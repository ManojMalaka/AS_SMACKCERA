...
import com.datamation.smackcerasfa.controller.DashboardController;
import com.datamation.smackcerasfa.controller.OrderController;
import com.datamation.smackcerasfa.model.CustomNameValuePair;
import com.datamation.smackcerasfa.model.InvHed;
...
public class NetworkFunctions {
    ...
    public String getItemPrices(String repCode) throws IOException {
        ...
        Log.d(LOG_TAG, "Getting fItemPri : " + baseURL + "fItemPri" + restOfURL  + params);

        return getFromServer(baseURL + "fItemPri" + restOfURL , params);
    ...
    public String getItems(String repCode) throws IOException {
        ...
        Log.d(LOG_TAG, "Getting fItems : " + baseURL + "fItems" + restOfURL+  params);

        return getFromServer(baseURL + "fItems" + restOfURL , params);
...
//    }
    ...
    public String getFSDisc() throws IOException {

        List<CustomNameValuePair> params = new ArrayList<>();

        Log.d(LOG_TAG, "Getting fsdiscdet : " + baseURL + "FSDisc" + restOfURL + params);

        return getFromServer(baseURL + "FSDisc" + restOfURL, params);
    }
