...
import com.datamation.smackcerasfa.utils.CustomFont;
...
//        long initialDifferential = sharedPref.getLong("time_differential", 0);
    ...
    public String getBaseURL() {
        ...
        return sharedPref.getString("baseURL", "http://104.43.12.101");
    ...
    public String getConsoleDB() {
        ...
        return sharedPref.getString("Console_DB", "Test_SmackCera");
    ...
    public String getDistDB() {
        ...
        return sharedPref.getString("Dist_DB", "Test_SmackCera");
