...
public class SalRepController {
    ...
    public static final String FSALREP_CASHFLOT= "CashFlot";
    public static final String FSALREP_PASSWORD= "Password";
    public static final String FSALREP_SALES_FLAG= "SalesFlg";


    // create String
    public static final String CREATE_FSALREP_TABLE = "CREATE  TABLE IF NOT EXISTS " + TABLE_FSALREP
            + " (" + FSALREP_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
            + FSALREP_ADDMACH + " TEXT, "
            + FSALREP_ADDUSER + " TEXT, "
            + FSALREP_REP_TCODE+ " TEXT, "
            + FSALREP_RECORDID + " TEXT, "
            ...
            + FSALREP_CASHFLOT + " TEXT, "
            + FSALREP_ASE_CODE + " TEXT, "
    ...
    public int createOrUpdateSalRep(ArrayList<SalRep> list) {
        ...
        try {
            ...
            for (SalRep rep : list) {
                ...
                values.put(FSALREP_ASE_CODE, rep.getASE_CODE());
                values.put(FSALREP_AREA_CODE, rep.getAREACODE());
                values.put(FSALREP_CASHFLOT, rep.getCASHFLOT());
